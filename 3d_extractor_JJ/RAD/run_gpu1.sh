...
echo "=========================================="
echo "[GPU1] Phase 1: Building memory banks"
echo "  items: $ITEMS"
echo "=========================================="
...
echo ""
echo "=========================================="
echo "[GPU1] Phase 2: Inference + Evaluation"
echo "  items: $ITEMS"
echo "=========================================="
...
.venv/bin/python rad_3d.py \
    ...
    --cache_dir "$CACHE_DIR" \
    --save_name "3d_multilayer_36911_448_gpu1" \
    --render_workers 28 \
    --device "$DEVICE"
